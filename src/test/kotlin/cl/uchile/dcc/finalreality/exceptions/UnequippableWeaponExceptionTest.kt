...
internal class UnequippableWeaponExceptionTest {
    ...
    @Test
    fun testKnight() {
        val knight = Knight("Knight", 10, 10, controller)
    ...
    @Test
    fun testEngineer() {
        val engineer = Engineer("Test", 5, 0, controller)
    ...
    @Test
    fun testThief() {
        val thief = Thief("Test", 5, 0, controller)
    ...
    @Test
    fun testWhiteMage() {
        val whiteMage = WhiteMage("Test", 5, 10, 5, controller)
    ...
    @Test
    fun testBlackMage() {
        val blackMage = BlackMage("Test", 5, 10, 5, controller)
